...
{
    /// <summary>
    /// Định nghĩa các phép sử lý dữ liệu thường dùng trên bảng (Customer,Employee,Shippers,...)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public interface ICommonDAL<T> where T : class
    {
        /// <summary>
        /// Tìm kiếm và lấy danh sách dữ liệu (Kiểu T) dưới dạng có phân trang
        /// </summary>
        ...
        /// </summary>
        /// <param name="searchValue">Giá trị cần tìm kiếm (chuỗi rỗng nếu đếm toàn bộ dữ liệu)</param>
        /// <returns></returns>
        ...
        bool Update(T data);
        /// <summary>
        /// Xóa một bản ghi dựa vào giá trị khóa chính/id
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        bool Delete(int id);
        /// <summary>
        /// Kiểm tra xem một bản ghi dữ liệu có khóa id hiện đang có dữ liệu tham chiếu ở bảng khác hay không? 
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        bool InUsed(int id);
