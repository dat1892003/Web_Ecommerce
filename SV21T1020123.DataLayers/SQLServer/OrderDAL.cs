...
namespace SV21T1020123.DataLayers.SQLServer
{
    public class OrderDAL : BaseDAL, IOrderDAL
    {
        ...
        public int CustomerOrderCount(int status = 0, DateTime? fromTime = null, DateTime? toTime = null, string searchValue = "", int customerId = 0)
        {
            int count = 0;
            searchValue = $"%{searchValue}%";
            using (var connection = OpenConnection())
        ...
        public Order? Get(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                var sql = @"select o.*,c.CustomerName,c.ContactName as CustomerContactName,c.Address as CustomerAddress,c.Phone as CustomerPhone,c.Email as CustomerEmail,
                ...
                data = connection.QueryFirstOrDefault<Order>(sql, parameters, commandType: System.Data.CommandType.Text);
                connection.Close();
            }
            return data;
        }
        ...
        public OrderDetail? GetDetail(int orderID, int productID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                data = connection.QueryFirstOrDefault<OrderDetail>(sql, parameters, commandType: System.Data.CommandType.Text);
                connection.Close();
            }
            return data;
        }
        public IList<Order> List(int page = 1, int pageSize = 0, int status = 0, DateTime? fromTime = null, 
            DateTime? toTime = null, string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                var sql = @"with cte as
                            (
                            select row_number() over(order by o.OrderTime desc) as RowNumber,o.*,c.CustomerName,c.ContactName as CustomerContactName,
                                    c.Address as CustomerAddress,c.Phone as CustomerPhone,c.Email as CustomerEmail,e.FullName as EmployeeName,s.ShipperName,s.Phone as ShipperPhone
                            from Orders as o
                                left join Customers as c on o.CustomerID = c.CustomerID
                                left join Employees as e on o.EmployeeID = e.EmployeeID
                                left join Shippers as s on o.ShipperID = s.ShipperID
        ...
        public IList<Order> CustomerOrderList(int page = 1, int pageSize = 0, int status = 0, DateTime? fromTime = null,
        DateTime? toTime = null, string searchValue = "", int customerId = 0)
        {
            List<Order> list = new List<Order>();
            searchValue = $"%{searchValue}%";
            using (var connection = OpenConnection())
        ...
        public IList<OrderDetail> ListDetails(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<OrderDetail>(sql, parameters, commandType: System.Data.CommandType.Text).ToList();
                connection.Close();                
            }
            return list;
        }
