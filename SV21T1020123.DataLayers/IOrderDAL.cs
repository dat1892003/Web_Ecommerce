...
namespace SV21T1020123.DataLayers
{
    public interface IOrderDAL
    {
        ...
        /// <summary>
        /// Lấy dữ liệu đơn của khách hàng dạng phân trang
        /// </summary>
        IList<Order> CustomerOrderList(int page = 1, int pageSize = 0,
        ...
        string searchValue = "");
        /// <summary>
        /// Đếm số lượng đơn của khách hàng
        /// </summary>
        int CustomerOrderCount(int status = 0, DateTime? fromTime = null, DateTime? toTime = null,
